...
EVAL_PID=0x9	# evaluate text with destination; who, text
...
PROBE=0xe	# probe to determine internal states
MAX_PIDS=0xf	# number of PIDS defined

pids = {
	CONFIG_PID:"CONFIG_PID",	# for exchanging configurations on a link: spid + specifics; ie testframe
	...
	EVAL_PID:"EVAL_PID",	# evaluate text with destination; who, text
	...
	PROBE:"PROBE",	# probe to determine internal states
...
MAIN_HOST=0x2	# host port through serial
ETM_HOST=0x3	# host side through ETM
